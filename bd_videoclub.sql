...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2021 a las 17:25:04
...
CREATE TABLE `usuarios` (
  ...
  `tipo_usuario` set('normal','administrador','','') NOT NULL,
...
('Akiuro', 'adrianmendozasantano@gmail.com', 1, '$2y$10$.40gkP6z2076iucrPYnwJueVZnpkVoKzuSaL0L8l6jne5h7j2uTEy', 'administrador', 349, 34),
('Paco', 'Fiestas@gmail.com', 1, '$2y$10$rnTZiA3.H7Wkcb5UqdZIdeUMRQxhmqtM8awTiXLzT4owwkHaVEXui', 'normal', 0, 35),
('1234', '1234@gmail.com', 0, '$2y$10$SP76RCKR8.be32A/1oP4TuIM2x2xER7s7EmmGXcEFOrqc043eQ0FK', 'normal', 0, 40),
('jesus', 'jesus@gmail.com', 1, '$2y$10$hLfLo9HF57H6IvCwEzy8vOSpMNn6WcgjNHa0kvgl//s1qvqi9MPzu', 'administrador', 0, 41),
('paquito', 'paquito@gmail.com', 1, '$2y$10$aex0q4VMZE5asGBvgW.CEe40R05wtf1FplJ2wKVFNKttHKU3czTGi', 'normal', 0, 44);
...
('Mortal Kombat', 'Akiuro', 'compra', '2021-06-03', '2021-06-10', 14.95, 'Si', 47),
('Mortal Kombat', 'Akiuro', 'compra', '2021-06-03', '2021-06-10', 14.95, 'Si', 48),
('Mortal Kombat', 'Akiuro', 'alquiler', '2021-06-03', '2021-06-10', 2.99, 'Si', 49),
('Los Increíbles 2', 'Akiuro', 'alquiler', '2021-06-03', '2021-06-10', 2.99, 'Si', 50);
