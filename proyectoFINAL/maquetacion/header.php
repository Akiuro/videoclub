...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbartop">
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-7">
                                            <div class="card-body">
                                                ...
                                                <p class="modal-title">&#127871 Bienvenido a Film's Corner &#127871</p>
                                                </div>
                                                ...
                                                <button id="inicioToRegistro" data-bs-target="#modalRegistro" class='text-reset data-bs-toggle="modal" data-bs-dismiss="modal"'><p>Registrate aquí</p> </button>
    ...
    $("#insertarSaldo").on("click", function(e) {
        if ($("#saldoInsertar").val() == "") {} else if ($("#saldoInsertar").val().slice(0, 1) == "-") {} else {
